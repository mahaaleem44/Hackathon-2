  ...
  return (
    <div>
      ...
      <div className="bg-white font-[sans-serif]">
        <div className="min-h-auto flex flex-col items-center justify-center py-6 px-4 md:px-8 lg:px-16">
          <div className="max-w-md w-full">
            <div className="p-8 rounded-2xl bg-white shadow md:p-10 lg:p-12">
              <h2 className="text-gray-800 text-center text-2xl md:text-3xl font-bold">
                Login
              </h2>
                ...
                <div>
                  <div className="relative flex items-center">
                    <input
                      ...
                      type="text"
                      required
                      className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md focus:ring focus:ring-blue-300 focus:outline-none"
          ...
          <div className="mt-8">
            <Image className="max-w-full mx-auto" src={label} alt="label" />
          </div>
        </div>
      </div>
    </div>
